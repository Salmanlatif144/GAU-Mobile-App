...
export default function Complaints() {
  ...
  const [resolved, setresolved] = useState(23);

  const [progress, setProgress] = useState(0.9);
  const progressText = progress * 100;
  const [resolvedprogress, setComplaintProgress] = useState(0.4);
  const ComplaimtText = resolvedprogress * 100;
      ...
      <ScrollView style={globalstyles.whitecont2}>
        <View style={globalstyles.dashcard2}>
          <View style={globalstyles.cardminicont}>
            ...
            <Text style={globalstyles.cardboldtext}>{pending}</Text>
            <View>
        ...
        <View style={globalstyles.dashcard2}>
          <View style={globalstyles.cardminicont}>
            ...
            <Text style={globalstyles.cardboldtext}>{resolved}</Text>
            <View>
